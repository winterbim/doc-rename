...
export const metadata: Metadata = {
  ...
  description: 'Paiement reçu. Activation de votre accès BIMCHECK-Rename.',
      ...
      <Container size="md" className="py-16">
        <Card variant="elevated" padding="lg" className="mx-auto max-w-xl text-center">
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-tight">
            Merci — on active votre accès.
          </h1>
          <p className="mt-4 text-sm leading-relaxed text-ink-soft">
            BIMCHECK-Rename V1 provisionne les plans payants sous{' '}
            <strong className="text-ink">1 jour ouvré</strong> après confirmation
            Stripe (ou devis). Vous recevez un email avec la suite :
            connexion compte et/ou mot d’accès si applicable.
          </p>
          <ul className="mt-6 space-y-2 text-left text-sm text-ink-soft">
            ...
            <li>• Créez un compte (Google / GitHub) pour préparer la sync des conventions.</li>
