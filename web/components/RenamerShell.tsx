    ...
    >
      ...
      {PAID_ACCOUNTS_ENABLED && <div className="border-b border-border bg-gradient-to-r from-indigo-600 to-indigo-700 px-5 py-2.5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <a
            href="/pricing"
            className="inline-flex items-center gap-1.5 rounded-md bg-paper px-3 py-1.5 text-xs font-semibold text-indigo-700 shadow-sm hover:bg-indigo-50 transition-colors"
          >
      ...
      <main className="flex flex-1 gap-0 lg:min-h-0 lg:overflow-hidden">
        ...
        {rightPaneOpen && (
          <aside
            className="hidden xl:flex w-72 shrink-0 flex-col border-l border-line bg-surface dark:bg-paper-2 min-h-0 overflow-hidden"
